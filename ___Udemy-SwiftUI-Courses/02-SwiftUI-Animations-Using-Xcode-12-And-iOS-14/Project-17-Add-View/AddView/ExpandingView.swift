...
struct ExpandingView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .background(expand ? backgroundColor.opacity(0.15) : .white)
...
struct ExpandingView_Previews: PreviewProvider {
    static var previews: some View {
        ExpandingView(expand: .constant(true), direction: .bottom, symbolName: "doc.fill", color: Color("red"), backgroundColor: Color("red"))
    }
}
#endif
