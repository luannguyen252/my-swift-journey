    ...
    var body: some View {
        VStack {
            VStack(spacing: 4) {
                ...
                Text("Trải nghiệm của bạn với ViettelPay thế nào?")
                    .font(.system(size: 32))
                    .fontWeight(.heavy)
                ...
                Text(value <= 0.3 ? "Tôi cảm thấy tệ lắm ý" : (value > 0.3 && value <= 0.7 ? "Cũng bình thường thôi" : "Tuyệt vời, tôi yêu ViettelPay"))
                    .font(.system(size: 24))
                    .fontWeight(.regular)
                    .foregroundColor(.black)
                    .padding(.top, 16)
            ...
            // Button
            Button(action: {
                print("Người dùng bấm vào nút gửi cảm nhận đánh giá")
            }, label: {
                // Text("Done")
                Text("Cảm nhận xong")
                    .fontWeight(.semibold)
