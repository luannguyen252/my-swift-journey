...
struct AnimationsGraphAnimations: View {
    ...
    var body: some View {
        VStack {
            ...
            .border(Color("dark").opacity(0.25), width: 1)
            .padding()
...
#if DEBUG
struct AnimationsGraphAnimations_Previews: PreviewProvider {
    static var previews: some View {
        AnimationsGraphAnimations()
    }
}
#endif
