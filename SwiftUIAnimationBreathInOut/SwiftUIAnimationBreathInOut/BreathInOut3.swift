        ...
        ZStack {
            ZStack {
                ZStack {
                    ...
                    ZStack {
                        RadialGradient(gradient: Gradient(colors: [Color.yellow, Color.orange]), center: .center, startRadius: 5, endRadius: 90)
                            .clipShape(Circle()).frame(width: 80, height: 80)
                            .offset(y: 41.0)
                    } //: ZSTACK
                } //: ZSTACK
...
// MARK: - PREVIEW
#if DEBUG
struct BreathInOut3_Previews: PreviewProvider {
