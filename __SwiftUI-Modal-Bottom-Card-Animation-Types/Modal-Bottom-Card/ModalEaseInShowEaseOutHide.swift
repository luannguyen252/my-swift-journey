...
struct ModalEaseInShowEaseOutHide: View {
    ...
    var body: some View {
        ZStack {
            ...
            if show {
                ...
                .animation(show ? .easeIn(duration: 0.3) : .easeOut(duration: 0.3))
...
struct ModalEaseInShowEaseOutHide_Previews: PreviewProvider {
    static var previews: some View {
        ModalEaseInShowEaseOutHide()
    }
}
