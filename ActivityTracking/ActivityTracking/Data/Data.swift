...
struct Data {
    static let activityItems = [
        ...
        ActivityItem(title: "swimming", color: Color.blue, imageName: "figure.walk", imageRoataion: 90, progress: 0.75),
        ActivityItem(title: "cycling", color: Color.purple, imageName: "bicycle", imageRoataion: 0, progress: 0.25)
    ]
    ...
    static let valueItems = [
        ...
        ValueItem(title: "swimming", imageName: "figure.walk", value: 293, selected: false, imageColor: Color.blue, imageRotation: 90, caloryData: caloryDataSwimming),
        ValueItem(title: "cycling", imageName: "bicycle", value: 250, selected: false, imageColor: Color.purple, imageRotation: 0, caloryData: caloryDataCycling)
    ]
