...
struct ColorConstants {
    ...
    static let barHighlightedBackground = LinearGradient(gradient: Gradient(colors: [graphBarHighlighted.opacity(0.2), graphBarHighlighted.opacity(0.8)]), startPoint: .top, endPoint: .bottom)
}
