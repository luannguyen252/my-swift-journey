...
class SwipeRightToPopViewController<Content>: UIHostingController<Content>, UINavigationControllerDelegate where Content: View {
    ...
    public func addGesture() {
        if !gestureAdded {
            ...
            while true {
                if (currentVc.navigationController != nil) && currentVc.navigationController?.viewControllers.count > 1 {
...
// MARK: - LAZY POP SWIFTUI COMPONENT
